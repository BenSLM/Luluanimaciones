      ...
      <div className="contenedor relative grid items-center gap-10 lg:grid-cols-[1.05fr_1fr] lg:gap-14">
        ...
        <div className="relative">
          <div className="grid grid-cols-5 grid-rows-6 gap-3 md:gap-4">
            <div className="group col-span-3 row-span-6 overflow-hidden rounded-burbuja bg-rosa-suave shadow-[0_30px_60px_-15px_rgba(43,36,56,0.4)]">
              <img
            ...
            <div className="col-span-2 row-span-3 rotate-2 rounded-sm bg-white p-2 shadow-[0_18px_40px_-14px_rgba(43,36,56,0.35)] transition-transform duration-300 hover:rotate-0 hover:-translate-y-1">
            ...
            <div className="group col-span-2 row-span-3 overflow-hidden rounded-card bg-rosa/40 shadow-[0_18px_40px_-14px_rgba(43,36,56,0.35)]">
              <img
