      ...
      <div className="contenedor relative grid items-center gap-10 lg:grid-cols-[1.05fr_1fr] lg:gap-14">
        ...
        >
          <div className="grid grid-cols-5 grid-rows-6 gap-3 md:gap-4">
            ...
            >
              <img
                src={asset("images/galeria/foto-grupal-payaso-lulu-1080.webp")}
            ...
            >
              <div className="h-full w-full overflow-hidden rounded-xs">
                <img
                  src={asset("images/galeria/pintacarita-spiderman-1080.webp")}
                  alt="Invitado luciendo un diseño de pintacaritas de colores"
                  loading="lazy"
                  decoding="async"
            ...
            >
<img
                  src={asset("images/galeria/foto-grupal-nueva-1080.webp")}
